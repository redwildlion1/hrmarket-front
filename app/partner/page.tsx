      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-background to-accent/5 py-20 md:py-28">
        ...
        <div className="container relative mx-auto px-4">
          ...
          >
            ...
            <p className="text-pretty text-xl text-muted-foreground md:text-2xl">{t("partner.subtitle")}</p>
          </motion.div>
        </div>
      </section>
            ...
            {tiers.map((tier) => {
              ...
              return (
                <motion.div key={tier.id} variants={itemVariants}>
                  ...
                  >
                    {tier.popular && (
                      <div className="absolute top-0 right-0 bg-gradient-red text-white px-4 py-1 text-sm font-semibold rounded-bl-lg">
                        {t("partner.popular")}
                      </div>
                    )}
                    <CardHeader className="pb-8 pt-8">
                      ...
                      <div className="mt-6">
                        ...
                        <span className="text-lg text-muted-foreground">/{t("partner.monthly")}</span>
                      </div>
                    </CardHeader>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            <div className="mb-12 text-center">
              <h2 className="mb-4 text-4xl font-bold md:text-5xl">{t("partner.faq.title")}</h2>
              <p className="text-xl text-muted-foreground">{t("partner.faq.subtitle")}</p>
            </div>
