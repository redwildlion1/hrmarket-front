  ...
  <div style="max-width: 1100px; margin: 0 auto;">
    ...
    <div style="background: #1e293b; padding: 4rem 3rem; border-radius: 1.25rem; border: 1px solid #334155;">
      ...
      <div style="background: #0f172a; padding: 2.5rem; border-radius: 1rem; margin: 2.5rem 0; border-left: 4px solid #8b5cf6;">
        <h4 style="color: #a78bfa; font-size: 1.375rem; font-weight: 700; margin-bottom: 1.5rem;">🎯 Transparency & Explainability</h4>
      ...
      <div style="background: linear-gradient(135deg, #1e40af, #3b82f6); padding: 3.5rem; border-radius: 1.25rem; text-align: center; margin-top: 4rem;">
        ...
        <a href="#" style="display: inline-block; background: white; color: #1e40af; padding: 1rem 2.5rem; border-radius: 0.75rem; font-weight: 700; text-decoration: none; box-shadow: 0 10px 30px rgba(0,0,0,0.3); font-size: 1.125rem;">Schedule a Consultation</a>
      </div>
    </div>
  </div>
</div>
...
<div style="max-width: 900px; margin: 0 auto; font-family: 'Georgia', serif; padding: 4rem 3rem;">
  ...
  <div style="font-size: 1.25rem; line-height: 1.9; color: #3f3f46;">
    ...
    <h2 style="font-size: 2.5rem; font-weight: 700; margin-top: 5rem; margin-bottom: 2rem; color: #18181b; border-bottom: 3px solid #18181b; padding-bottom: 1rem; letter-spacing: -0.01em;">IV. Strategic Recommendations</h2>
    
    <p style="margin-bottom: 2rem;">Based on our comprehensive analysis, we offer the following strategic recommendations for HR leaders:</p>
...
<div style="font-family: 'Inter', sans-serif; background: #f8fafc; color: #0f172a;">
  <div style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); color: white; padding: 5rem 3rem; position: relative; overflow: hidden;">
    ...
    <div style="max-width: 1200px; margin: 0 auto; position: relative; z-index: 10;">
      ...
      <p style="font-size: 1.75rem; line-height: 1.5; color: #cbd5e1; margin-bottom: 3rem; max-width: 900px; font-weight: 500;">Where innovation meets implementation: Join 1,500+ HR leaders, executives, and thought leaders shaping the next era of workplace excellence</p>
      ...
      <div style="display: flex; gap: 2rem; flex-wrap: wrap;">
        ...
        <a href="#" style="display: inline-block; background: rgba(255,255,255,0.1); backdrop-filter: blur(10px); border: 2px solid rgba(255,255,255,0.2); color: white; padding: 1.25rem 3rem; border-radius: 0.75rem; font-weight: 700; text-decoration: none;">Download Brochure</a>
      </div>
    </div>
  </div>
  ...
  <div style="max-width: 1400px; margin: 0 auto; padding: 6rem 3rem;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(380px, 1fr)); gap: 3rem; margin-bottom: 6rem;">
      <div style="background: white; border: 1px solid #e2e8f0; padding: 3rem; border-radius: 1.25rem; box-shadow: 0 4px 20px rgba(0,0,0,0.05); transition: all 0.3s;">
    ...
    <div style="background: linear-gradient(135deg, #0f172a, #1e293b); padding: 5rem 4rem; border-radius: 2rem; text-align: center; margin: 6rem 0;">
    ...
    <div style="background: white; border: 2px solid #e2e8f0; padding: 4rem; border-radius: 1.5rem;">
      <h2 style="color: #0f172a; font-size: 2.5rem; font-weight: 900; text-align: center; margin-bottom: 3rem;">Frequently Asked Questions</h2>
      
      <div style="display: grid; gap: 2rem; max-width: 900px; margin: 0 auto;">
        <div>
          <h4 style="color: #3b82f6; font-size: 1.25rem; font-weight: 700; margin-bottom: 0.75rem;">Can I switch between in-person and virtual attendance?</h4>
          <p style="color: #475569; font-size: 1rem; line-height: 1.7; margin: 0;">Yes! You can upgrade from virtual to in-person up until one week before the event. Contact our registration team for assistance.</p>
        </div>
        
        <div>
          <h4 style="color: #3b82f6; font-size: 1.25rem; font-weight: 700; margin-bottom: 0.75rem;">Are group discounts available?</h4>
          <p style="color: #475569; font-size: 1rem; line-height: 1.7; margin: 0;">Groups of 5+ receive 20% off, and groups of 10+ receive 30% off. Email groups@conference.com for a custom quote.</p>
        </div>
        
        <div>
          <h4 style="color: #3b82f6; font-size: 1.25rem; font-weight: 700; margin-bottom: 0.75rem;">Will session recordings be available after the conference?</h4>
          <p style="color: #475569; font-size: 1rem; line-height: 1.7; margin: 0;">Yes, all registered attendees receive access to session recordings for 6 months following the event.</p>
        </div>
        
        <div>
          <h4 style="color: #3b82f6; font-size: 1.25rem; font-weight: 700; margin-bottom: 0.75rem;">What is your cancellation policy?</h4>
          <p style="color: #475569; font-size: 1rem; line-height: 1.7; margin: 0;">Full refund available until 30 days before the event. Within 30 days, we offer credit toward next year's conference.</p>
        </div>
      </div>
    </div>
    
    <div style="text-align: center; margin: 6rem 0;">
      <h3 style="color: #0f172a; font-size: 2.5rem; font-weight: 900; margin-bottom: 2rem;">Ready to Transform Your HR Strategy?</h3>
      <p style="color: #475569; font-size: 1.25rem; line-height: 1.7; margin-bottom: 3rem; max-width: 700px; margin-left: auto; margin-right: auto;">Join 1,500+ forward-thinking HR professionals. Register today and be part of the conversation shaping the future of work.</p>
      <a href="#" style="display: inline-block; background: linear-gradient(135deg, #3b82f6, #6366f1); color: white; padding: 1.5rem 4rem; border-radius: 0.75rem; font-weight: 800; text-decoration: none; font-size: 1.25rem; box-shadow: 0 15px 50px rgba(59, 130, 246, 0.4);">Secure Your Spot Now</a>
      <p style="color: #64748b; font-size: 0.875rem; margin-top: 1.5rem;">Questions? Email info@futureofworksummit.com or call (555) 123-4567</p>
    </div>
  </div>
</div>
    `,
...
<div style="font-family: 'Inter', sans-serif; background: linear-gradient(180deg, #1e1b4b 0%, #312e81 50%, #1e1b4b 100%); color: white; padding: 0;">
  ...
  <div style="max-width: 1400px; margin: 0 auto; padding: 6rem 3rem;">
    <div style="text-align: center; margin-bottom: 5rem;">
      ...
      <p style="font-size: 1.25rem; color: #c7d2fe; line-height: 1.8; max-width: 800px; margin: 0 auto;">Join us for an unforgettable evening of elegance, celebration, and recognition as we honor the outstanding achievements of our team and partners</p>
    </div>
    ...
    <div style="background: linear-gradient(135deg, #fbbf24, #f59e0b); padding: 5rem 4rem; border-radius: 2rem; text-align: center; margin: 6rem 0; box-shadow: 0 30px 80px rgba(251, 191, 36, 0.3);">
    ...
    <div style="text-align: center; padding: 4rem 2rem; background: linear-gradient(135deg, rgba(251, 191, 36, 0.1), rgba(245, 158, 11, 0.1)); border-radius: 1.5rem; margin-top: 6rem;">
      ...
      <p style="color: #c7d2fe; font-size: 1.25rem; line-height: 1.7; margin-bottom: 3rem; max-width: 700px; margin-left: auto; margin-right: auto;">Limited seating available. RSVP by March 5th to guarantee your place at this unforgettable celebration.</p>
  ...
  },
  {
    ...
    preview: "🎪",
    html: `
<div style="font-family: 'Inter', sans-serif; background: linear-gradient(180deg, #fef3c7 0%, #ffffff 100%);">
  <div style="background: linear-gradient(135deg, #f59e0b 0%, #ec4899 50%, #8b5cf6 100%); padding: 6rem 3rem; position: relative; overflow: hidden;">
    <div style="position: absolute; top: 10%; left: 5%; width: 200px; height: 200px; background: rgba(255,255,255,0.1); border-radius: 50%; animation: float 6s ease-in-out infinite;"></div>
    <div style="position: absolute; bottom: 20%; right: 10%; width: 150px; height: 150px; background: rgba(255,255,255,0.15); border-radius: 50%; animation: float 8s ease-in-out infinite;"></div>
    
    <div style="max-width: 1200px; margin: 0 auto; text-align: center; position: relative; z-index: 10;">
      <div style="display: inline-block; background: rgba(255,255,255,0.25); backdrop-filter: blur(10px); padding: 1rem 2.5rem; border-radius: 3rem; margin-bottom: 2rem;">
        <p style="color: white; font-size: 1rem; font-weight: 800; letter-spacing: 0.15rem; margin: 0;">🎉 ANNUAL TEAM RETREAT 2025 🎉</p>
      </div>
      
      <h1 style="font-size: 5.5rem; font-weight: 900; line-height: 1; margin-bottom: 2rem; color: white; text-shadow: 0 4px 30px rgba(0,0,0,0.3); letter-spacing: -0.03em;">Adventure Awaits!</h1>
      
      <p style="font-size: 2rem; line-height: 1.4; color: rgba(255,255,255,0.95); margin-bottom: 3rem; font-weight: 600; max-width: 900px; margin-left: auto; margin-right: auto; text-shadow: 0 2px 10px rgba(0,0,0,0.2);">Three days of connection, challenges, and celebration as we build stronger bonds and create unforgettable memories together</p>
      
      <div style="display: flex; justify-content: center; align-items: center; gap: 2.5rem; flex-wrap: wrap; font-size: 1.25rem; color: white; margin-bottom: 3rem; font-weight: 600;">
        <div style="display: flex; align-items: center; gap: 0.75rem; background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); padding: 1rem 2rem; border-radius: 2rem;">
          <span style="font-size: 1.75rem;">📅</span>
          <span>June 10-12, 2025</span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.75rem; background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); padding: 1rem 2rem; border-radius: 2rem;">
          <span style="font-size: 1.75rem;">🏔️</span>
          <span>Mountain Vista Resort</span>
        </div>
        <div style="display: flex; align-items: center; gap: 0.75rem; background: rgba(255,255,255,0.2); backdrop-filter: blur(10px); padding: 1rem 2rem; border-radius: 2rem;">
          <span style="font-size: 1.75rem;">👥</span>
          <span>All Company Event</span>
        </div>
      </div>
      
      <a href="#" style="display: inline-block; background: white; color: #f59e0b; padding: 1.5rem 4rem; border-radius: 3rem; font-weight: 900; text-decoration: none; font-size: 1.375rem; box-shadow: 0 15px 50px rgba(0,0,0,0.3); text-transform: uppercase; letter-spacing: 0.05em;">I'm In - Sign Me Up!</a>
    </div>
  </div>
  
  <div style="max-width: 1400px; margin: 0 auto; padding: 6rem 3rem;">
    <div style="text-align: center; margin-bottom: 5rem;">
      <p style="color: #f59e0b; font-size: 1.125rem; font-weight: 800; letter-spacing: 0.1rem; margin-bottom: 1rem; text-transform: uppercase;">Get Ready For</p>
      <h2 style="font-size: 4rem; font-weight: 900; margin-bottom: 2rem; background: linear-gradient(135deg, #f59e0b, #ec4899, #8b5cf6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: -0.02em;">Epic Activities & Adventures</h2>
      <p style="font-size: 1.375rem; color: #475569; line-height: 1.8; max-width: 800px; margin: 0 auto;">Three days of connection, challenges, and celebration as we build stronger bonds and create unforgettable memories together</p>
    </div>
    
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(340px, 1fr)); gap: 2.5rem; margin-bottom: 6rem;">
      <div style="background: linear-gradient(135deg, #fef3c7, #fde68a); padding: 3rem; border-radius: 2rem; transform: rotate(-2deg); box-shadow: 0 15px 40px rgba(245, 158, 11, 0.2); transition: transform 0.3s;">
        <p style="font-size: 4rem; margin-bottom: 1.5rem; text-align: center;">🧗</p>
        <h3 style="color: #92400e; font-size: 1.75rem; font-weight: 900; margin-bottom: 1.25rem; text-align: center;">Adventure Challenge</h3>
        <p style="color: #78350f; font-size: 1.125rem; line-height: 1.7; margin-bottom: 1.5rem;">Rock climbing, zip-lining, and high ropes courses! Push your limits and support your teammates in thrilling outdoor challenges.</p>
        <ul style="color: #92400e; font-size: 1rem; line-height: 1.8; margin: 0; padding-left: 1.5rem;">
          <li>Professional guides & safety equipment</li>
          <li>All skill levels welcome</li>
          <li>Team-based challenges</li>
        </ul>
      </div>
      
      <div style="background: linear-gradient(135deg, #ddd6fe, #c4b5fd); padding: 3rem; border-radius: 2rem; transform: rotate(1deg); box-shadow: 0 15px 40px rgba(139, 92, 246, 0.2);">
        <p style="font-size: 4rem; margin-bottom: 1.5rem; text-align: center;">🎨</p>
        <h3 style="color: #5b21b6; font-size: 1.75rem; font-weight: 900; margin-bottom: 1.25rem; text-align: center;">Creative Workshops</h3>
        <p style="color: #6b21a8; font-size: 1.125rem; line-height: 1.7; margin-bottom: 1.5rem;">Unleash your creativity with hands-on workshops in painting, pottery, and team art projects. No experience needed!</p>
        <ul style="color: #7c3aed; font-size: 1rem; line-height: 1.8; margin: 0; padding-left: 1.5rem;">
          <li>Create team masterpieces</li>
          <li>Take home your artwork</li>
          <li>Led by local artists</li>
        </ul>
      </div>
      
      <div style="background: linear-gradient(135deg, #fecaca, #fca5a5); padding: 3rem; border-radius: 2rem; transform: rotate(-1deg); box-shadow: 0 15px 40px rgba(239, 68, 68, 0.2);">
        <p style="font-size: 4rem; margin-bottom: 1.5rem; text-align: center;">🍳</p>
        <h3 style="color: #991b1b; font-size: 1.75rem; font-weight: 900; margin-bottom: 1.25rem; text-align: center;">Cooking Competition</h3>
        <p style="color: #7f1d1d; font-size: 1.125rem; line-height: 1.7; margin-bottom: 1.5rem;">Think you can cook? Compete in our MasterChef-style cooking challenge with mystery ingredients and tight time limits!</p>
        <ul style="color: #991b1b; font-size: 1rem; line-height: 1.8; margin: 0; padding-left: 1.5rem;">
          <li>Teams of 4 compete</li>
          <li>Celebrity chef judges</li>
          <li>Prizes for winners</li>
        </ul>
      </div>
      
      <div style="background: linear-gradient(135deg, #bfdbfe, #93c5fd); padding: 3rem; border-radius: 2rem; transform: rotate(2deg); box-shadow: 0 15px 40px rgba(59, 130, 246, 0.2);">
        <p style="font-size: 4rem; margin-bottom: 1.5rem; text-align: center;">🏃</p>
        <h3 style="color: #1e3a8a; font-size: 1.75rem; font-weight: 900; margin-bottom: 1.25rem; text-align: center;">Amazing Race</h3>
        <p style="color: #1e40af; font-size: 1.125rem; line-height: 1.7; margin-bottom: 1.5rem;">Navigate through clues, solve puzzles, and complete challenges in our action-packed Amazing Race around the resort!</p>
        <ul style="color: #2563eb; font-size: 1rem; line-height: 1.8; margin: 0; padding-left: 1.5rem;">
          <li>Epic prize for winning team</li>
          <li>Photo and video challenges</li>
          <li>Surprise pit stops</li>
        </ul>
      </div>
      
      <div style="background: linear-gradient(135deg, #d1fae5, #a7f3d0); padding: 3rem; border-radius: 2rem; transform: rotate(-1deg); box-shadow: 0 15px 40px rgba(16, 185, 129, 0.2);">
        <p style="font-size: 4rem; margin-bottom: 1.5rem; text-align: center;">🧘</p>
        <h3 style="color: #065f46; font-size: 1.75rem; font-weight: 900; margin-bottom: 1.25rem; text-align: center;">Wellness & Relaxation</h3>
        <p style="color: #047857; font-size: 1.125rem; line-height: 1.7; margin-bottom: 1.5rem;">Need a break? Join sunrise yoga, meditation sessions, or book a spa treatment. Take time to recharge and reset.</p>
        <ul style="color: #059669; font-size: 1rem; line-height: 1.8; margin: 0; padding-left: 1.5rem;">
      ...
      <div style="background: linear-gradient(135deg, #fed7aa, #fdba74); padding: 3rem; border-radius: 2rem; transform: rotate(1deg); box-shadow: 0 15px 40px rgba(249, 115, 22, 0.2);">
        <p style="font-size: 4rem; margin-bottom: 1.5rem; text-align: center;">🎵</p>
        <h3 style="color: #7c2d12; font-size: 1.75rem; font-weight: 900; margin-bottom: 1.25rem; text-align: center;">Evening Entertainment</h3>
        <p style="color: #9a3412; font-size: 1.125rem; line-height: 1.7; margin-bottom: 1.5rem;">Karaoke night, talent show, and a closing beach party with live band! Show off your hidden talents and dance the night away.</p>
        <ul style="color: #c2410c; font-size: 1rem; line-height: 1.8; margin: 0; padding-left: 1.5rem;">
    ...
    <div style="background: linear-gradient(135deg, #ec4899, #f59e0b); padding: 6rem 4rem; border-radius: 2.5rem; text-align: center; margin: 6rem 0; box-shadow: 0 30px 80px rgba(236, 72, 153, 0.3);">
      <h2 style="color: white; font-size: 3.5rem; font-weight: 900; margin-bottom: 2rem; text-shadow: 0 2px 20px rgba(0,0,0,0.2);">Complete Schedule</h2>
      
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 3rem; margin-top: 4rem; text-align: left;">
        <div style="background: white; padding: 3rem; border-radius: 1.5rem;">
          <div style="background: linear-gradient(135deg, #f59e0b, #ec4899); color: white; display: inline-block; padding: 0.75rem 2rem; border-radius: 2rem; font-weight: 900; font-size: 1.125rem; margin-bottom: 2rem;">DAY 1 - FRIDAY</div>
          <div style="color: #1f2937;">
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #f59e0b; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">3:00 PM</strong>
              <span style="font-size: 1.125rem;">Check-in & Welcome Drinks</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #f59e0b; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">5:00 PM</strong>
              <span style="font-size: 1.125rem;">Ice Breaker Games</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #f59e0b; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">7:00 PM</strong>
              <span style="font-size: 1.125rem;">BBQ Dinner & Bonfire</span>
            </p>
            <p style="margin: 0;">
              <strong style="color: #f59e0b; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">9:00 PM</strong>
              <span style="font-size: 1.125rem;">Karaoke Night!</span>
            </p>
          </div>
        </div>
        
        <div style="background: white; padding: 3rem; border-radius: 1.5rem;">
          <div style="background: linear-gradient(135deg, #f59e0b, #ec4899); color: white; display: inline-block; padding: 0.75rem 2rem; border-radius: 2rem; font-weight: 900; font-size: 1.125rem; margin-bottom: 2rem;">DAY 2 - SATURDAY</div>
          <div style="color: #1f2937;">
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #ec4899; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">7:00 AM</strong>
              <span style="font-size: 1.125rem;">Sunrise Yoga (Optional)</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #ec4899; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">9:00 AM</strong>
              <span style="font-size: 1.125rem;">Adventure Challenges Begin!</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #ec4899; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">12:30 PM</strong>
              <span style="font-size: 1.125rem;">Lunch & Pool Time</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #ec4899; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">2:30 PM</strong>
              <span style="font-size: 1.125rem;">Amazing Race Competition</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #ec4899; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">7:00 PM</strong>
              <span style="font-size: 1.125rem;">Cooking Competition</span>
            </p>
            <p style="margin: 0;">
              <strong style="color: #ec4899; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">10:00 PM</strong>
              <span style="font-size: 1.125rem;">Talent Show & Awards</span>
            </p>
          </div>
        </div>
        
        <div style="background: white; padding: 3rem; border-radius: 1.5rem;">
          <div style="background: linear-gradient(135deg, #f59e0b, #ec4899); color: white; display: inline-block; padding: 0.75rem 2rem; border-radius: 2rem; font-weight: 900; font-size: 1.125rem; margin-bottom: 2rem;">DAY 3 - SUNDAY</div>
          <div style="color: #1f2937;">
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #8b5cf6; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">8:00 AM</strong>
              <span style="font-size: 1.125rem;">Breakfast & Reflection</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #8b5cf6; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">10:00 AM</strong>
              <span style="font-size: 1.125rem;">Creative Workshops</span>
            </p>
            <p style="margin-bottom: 1.5rem; padding-bottom: 1rem; border-bottom: 2px dashed #e5e7eb;">
              <strong style="color: #8b5cf6; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">12:30 PM</strong>
              <span style="font-size: 1.125rem;">Farewell Lunch</span>
            </p>
            <p style="margin: 0;">
              <strong style="color: #8b5cf6; display: block; font-size: 1.125rem; margin-bottom: 0.5rem;">2:00 PM</strong>
              <span style="font-size: 1.125rem;">Check-out & Departure</span>
            </p>
          </div>
        </div>
      </div>
