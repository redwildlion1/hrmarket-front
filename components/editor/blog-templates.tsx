...
<div style="font-family: 'Inter', sans-serif; background: linear-gradient(to bottom, #fef3c7, #fef9e7, #fff7ed); color: #0f172a; padding: 0;">
  <div style="background: linear-gradient(135deg, #f59e0b 0%, #fb923c 50%, #f97316 100%); padding: 5rem 3rem; position: relative; overflow: hidden;">
    ...
    <div style="position: relative; z-index: 10; max-width: 1200px; margin: 0 auto;">
      ...
      <p style="font-size: 1.75rem; line-height: 1.6; color: rgba(255,255,255,0.95); margin-bottom: 3rem; font-weight: 400; max-width: 850px;">Join us for an unforgettable day of connection, collaboration, and celebration as we strengthen our team bonds through exciting activities and shared experiences</p>
      ...
      <a href="#" style="display: inline-block; background: white; color: #f59e0b; padding: 1.25rem 3rem; border-radius: 0.75rem; font-weight: 800; text-decoration: none; font-size: 1.125rem; box-shadow: 0 10px 30px rgba(0,0,0,0.3); text-transform: uppercase; letter-spacing: 0.05em;">Confirm Attendance</a>
    </div>
  </div>
